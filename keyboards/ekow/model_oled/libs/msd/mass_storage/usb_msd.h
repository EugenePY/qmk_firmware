...
#define PACK_VAR __attribute__((packed))
#define bool_t bool
#define MS_EPSIZE 64
...
typedef struct {
    uint8_t byte[18];
} PACK_VAR msd_scsi_sense_response_t;
...
} PACK_VAR msd_scsi_inquiry_response_t;

/**
 * @brief Possible states for the USB mass storage driver
 */
typedef enum { MSD_IDLE, MSD_READ_COMMAND_BLOCK, MSD_RESET } msd_state_t;
...
typedef struct {
     ...
     */
    usbep_t bulk_ep_idx; // endpoint idx
